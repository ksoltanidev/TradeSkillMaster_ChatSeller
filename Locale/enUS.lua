...
L["Types: weapon, mount, pet, whistle, demon, incarnation, set, shield, tabard, misc, illusions, altars"] = true
...
L["CoD"] = true
L["Gather"] = true
L["No bank is open."] = true
L["Item not found in bank."] = true
L["Gathering %s from bank..."] = true
